...
const ProjectCard = () => {
    return (
        <div className='flex px-4 py-4 gap-4 bg-[#153448] rounded-2xl fotn-[Inter] '>
            <div className='px-4 grid place-items-center text-3xl font-[Roboto] font-bold'>1</div>
            <Image className='rounded-xl border border-white' src="/1.jpg" width={300} height={150} alt='picture' />
            <div className='flex flex-col justify-between py-2'>
                ...
                <div className='text-[#81CDFF] font-semibold'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ex suscipit possimus perspiciatis ut, cupiditate tempore est nemo maiores laudantium, a ullam nesciunt corrupti quisquam ipsa quod itaque animi, consequuntur voluptatibus commodi omnis voluptatem magni modi officia! Sequi beatae incidunt cumque recusandae sit sapiente vel, mollitia alias, eum, ipsum facere inventore provident. Eos laborum inventore est delectus?</div>
