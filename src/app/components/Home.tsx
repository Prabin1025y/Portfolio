...
const HomePage = () => {
    return (
        <div className='flex flex-col-reverse gap-10 lg:gap-5 xl:gap-0 xl:flex-row h-[calc(100vh-80px)] items-center justify-end pt-14 sm:pt-0 sm:justify-center font-[Inter]'>
