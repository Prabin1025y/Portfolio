...
const HomePage = () => {
    return (
        <section id='Home' className='flex flex-col-reverse gap-10 lg:gap-5 xl:gap-0 xl:flex-row h-fit sm:h-[calc(100vh-80px)] items-center justify-end pt-14  sm:justify-center font-[Inter]'>
