...
const ContactPage = () => {
    return (
        <div className=' bg-[#DCF2F1]  dark:bg-[#153448] w-screen  h-fit -translate-y-[125px] relative font-[Inter] flex justify-end px-56 py-20'>
            ...
            <div className='w-[90%] h-[80vh] bg-[#255676] rounded-md relative flex justify-end px-20 shadow-[18px_18px_24px_-17px_rgba(0,_0,_0,_0.8)]'>
                <div className='w-[40%] h-[80%] bg-[#0E1A21] absolute top-1/2 -translate-y-1/2 -left-1/2 translate-x-full rounded-md border shadow-[18px_18px_24px_-17px_rgba(0,_0,_0,_0.8)] p-10 flex flex-col items-center'>
                ...
                <form className='w-2/3 flex flex-col justify-center  gap-5'>
                    ...
                    <input className='rounded-md border border-slate-500 w-full h-10 bg-[#1A252B] px-4' placeholder='Full Name' type="text" name='fullname' required />
                    <input className='rounded-md border border-slate-500 w-full h-10 bg-[#1A252B] px-4' placeholder='Email' type="email" name='email' required />
                    {/* </div> */}
                    <textarea className='w-full rounded-md block border border-slate-500 bg-[#1A252B] p-4' placeholder='Type your message here.' name="message" id="message" rows={10} required></textarea>
