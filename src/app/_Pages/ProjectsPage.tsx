        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-6">
            {projects.map((project) => (
              ...
              //           key={tech}
              //           variant="secondary"
              //           className="font-normal bg-emerald-200 dark:bg-cyan-800"
              //         >
              //           {tech}
              //         </Badge>
              //       ))}
              ...
              //     <p className="text-cyan-950 dark:text-cyan-200">
              //       {project.description}
              //     </p>
              //   </CardContent>
              //   <CardFooter className="flex gap-3 bg-[#3AA6A6]  dark:bg-[#153448]">
              //     <Button
              //       disabled={unavailableProjects.includes(project.title)}
              //       asChild
              //       className={`flex-1 transition-transform duration-300 group-hover:translate-y-[-2px] ${
              //         unavailableProjects.includes(project.title) &&
              ...
              //         {notAWebsite.includes(project.title)
              //           ? "Download Link"
              //           : "Visit Site"}
              //       </Link>
              //     </Button>
              ...
              //     </Button>
              //   </CardFooter>
              //   {warningProjects.includes(project.title) && (
              //     <div className="pl-4 pr-2 items-center py-2 mx-6 mb-2 -mt-3 rounded-md bg-[#ff11114d] dark:bg-[#cd3b3b2a] text-[#980000] dark:text-[#ff4c4c] border dark:border-[#ff4c4c] border-[#980000] text-sm flex gap-2">
              //       <CircleAlert size={16} /> Site might take about 1 min to
              //       load the first time.
              //     </div>
              //   )}
              // </Card>
