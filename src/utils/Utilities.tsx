...
export const projects: Project[] = [
  ...
  },
  {
    ...
    techStack: ["python", "numpy", "jupyter notebook"],
    imageUrl: "/ProjectsImage/nn_from_scratch.png",
    websiteUrl: "",
    repositoryUrl: "https://github.com/Prabin1025y/NN-from-scratch",
    featured: true,
  },
  {
    id: "8",
    ...
    description:
      "A Python project implementing a simple neural network from scratch using NumPy to classify handwritten digits from the MNIST dataset.",
    techStack: ["typescript", "p5.js", "Genetic Algorithm"],
    imageUrl: "/ProjectsImage/steering.png",
    websiteUrl: "https://prabin1025y.github.io/Genetic-Algorithm-Steering/",
    repositoryUrl: "https://github.com/Prabin1025y/Genetic-Algorithm-Steering",
    featured: false,
  },
];
...
export const getProjectIcon = (projectName: string) => {
  switch (projectName) {
    case "GuffGaff":
      return (
        <MessageCircleMore className="h-5 w-5 text-cyan-500 dark:text-cyan-400" />
      );
    case "Raag":
      return <Music4 className="h-5 w-5 text-cyan-500 dark:text-cyan-400" />;
    case "StoreHub":
      return (
        <ShoppingCart className="h-5 w-5 text-cyan-500 dark:text-cyan-400" />
      );
    ...
    case "Flappy Bird AI (NeuroEvolution)":
      return <Bird className="h-5 w-5 text-cyan-500 dark:text-cyan-400" />;
    case "Neural Network from Scratch":
...
export const skills: Skill[] = [
  // Languages
  {
    ...
    level: "intermediate",
    category: "languages",
    logo: "/SkillIcons/js.svg",
  },
  {
    name: "TypeScript",
    level: "intermediate",
    category: "languages",
    logo: "/SkillIcons/ts.svg",
  },
  {
    name: "Python",
    level: "intermediate",
    category: "languages",
    logo: "/SkillIcons/python.svg",
  },
  {
    name: "C",
    level: "beginner",
    category: "languages",
    logo: "/SkillIcons/c.svg",
  },
  {
    name: "C++",
    level: "intermediate",
    category: "languages",
    logo: "/SkillIcons/cpp.svg",
  },
  ...
  // Technologies
  {
    ...
    logo: "/SkillIcons/react.svg",
  },
  {
    name: "HTML",
    level: "advanced",
    category: "technologies",
    logo: "/SkillIcons/html.svg",
  },
  {
    name: "CSS",
    level: "intermediate",
    category: "technologies",
    logo: "/SkillIcons/css.svg",
  },
  {
    name: "Node.js",
    level: "intermediate",
    category: "technologies",
    logo: "/SkillIcons/nodejs.svg",
  },
  {
    name: "Express.js",
    level: "intermediate",
    category: "technologies",
    logo: "/SkillIcons/express.svg",
  },
  {
    name: "NextJS",
    level: "intermediate",
    category: "technologies",
    logo: "/SkillIcons/nextjs.svg",
  },
  {
    name: "ShadCN",
    level: "intermediate",
    category: "technologies",
    logo: "/SkillIcons/shadcn.svg",
  },
  {
    name: "Socket.io",
    level: "beginner",
    category: "technologies",
    logo: "/SkillIcons/socketio.svg",
  },
  ...
  // Libraries
  {
    ...
    level: "intermediate",
    category: "libraries",
    logo: "/SkillIcons/zustand.ico",
  },
  {
    name: "Bcrypt.js",
    level: "beginner",
    category: "libraries",
    logo: "/SkillIcons/bcrypt.png",
  },
  {
    name: "JWT",
    level: "beginner",
    category: "libraries",
    logo: "/SkillIcons/jwt.svg",
  },
  ...
  //Design
  {
    ...
    level: "intermediate",
    category: "designing",
    logo: "/SkillIcons/figma.svg",
  },
  {
    name: "Photoshop",
    level: "intermediate",
    category: "designing",
    logo: "/SkillIcons/photoshop.svg",
  },
  ...
  // Database
  {
    ...
    level: "intermediate",
    category: "database",
    logo: "/SkillIcons/mongodb.svg",
  },
  {
    name: "Mongoose",
    level: "intermediate",
    category: "database",
    logo: "/SkillIcons/mongoose.svg",
  },
  {
    name: "PostgreSQL",
    level: "intermediate",
    category: "database",
    logo: "/SkillIcons/postgress.svg",
  },
  {
    name: "Convex",
    level: "beginner",
    category: "database",
    logo: "/SkillIcons/convex.ico",
  },
  {
    name: "Prisma",
    level: "beginner",
    category: "database",
    logo: "/SkillIcons/prisma.svg",
  },
];
...
export const unavailableProjects = ["StoreHub", "Neural Network from Scratch"];
